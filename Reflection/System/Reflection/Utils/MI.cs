...
namespace System.Reflection.Utils
{
	...
	public static class MethodInvoker
	{
		...
		{
			var dynamicMethod = new DynamicMethod($"FastInvoke_{methodInfo.Name}_{(directBoxValueAccess ? "direct" : "indirect")}", typeof(object), new Type[] { typeof(object), typeof(object[]) }, true);
