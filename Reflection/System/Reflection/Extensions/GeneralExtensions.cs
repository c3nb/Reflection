...
namespace System.Reflection.Extensions
{
	...
	public static class GeneralExtensions
	{
		...
		public static string FullDescription(this MethodBase member)
		{
			...
			var returnType = AccessUtils.GetReturnedType(member);
	...
	public static class CodeInstructionExtensions
	{
		...
		public static bool OperandIs(this CodeInstruction code, object value)
		{
			...
			if (AccessUtils.IsInteger(type) && AccessUtils.IsNumber(operandType))
				return Convert.ToInt64(code.operand) == Convert.ToInt64(value);
			if (AccessUtils.IsFloatingPoint(type) && AccessUtils.IsNumber(operandType))
